...
showUserMessage("Luca") // Envio de argumento
...
function sum(n1, n2) {
    ...
    let result = n1 + n2;
    document.write(`<p> soma de ${n1} + ${n2} é igual a ${result}.</p>`)
}
// Invocando a função
...
//É INDICADO QUE AS FUNÇÕES POSSUAM O MINÍMO DE RESPONSABILDADES POSSÍVEIS
